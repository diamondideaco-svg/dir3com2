...
const baseMigration = readFileSync('supabase/migrations-archive/20260829234937_dir120_revenue_request_transition_safety.sql', 'utf8');
const correctiveMigration = readFileSync('supabase/migrations-archive/20260830033103_dir120_marketplace_request_audit_logs.sql', 'utf8');
