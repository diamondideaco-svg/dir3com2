export default function AdminStats({ stats }: { stats: { total: number; pending: number; confirmed: number; completed: number; revenue: number } }) {
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px' }}>
      <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(212, 175, 55, 0.1)', borderRadius: '16px', padding: '18px' }}>
      ...
      <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(212, 175, 55, 0.1)', borderRadius: '16px', padding: '18px' }}>
        ...
        <div style={{ color: '#F4F1E8', fontSize: '1.6rem', fontWeight: 'bold', marginTop: '6px' }}>{stats.pending}</div>
      </div>
      <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(212, 175, 55, 0.1)', borderRadius: '16px', padding: '18px' }}>
        <div style={{ color: '#8A9BB0', fontSize: '0.9rem' }}>مؤكد</div>
        <div style={{ color: '#F4F1E8', fontSize: '1.6rem', fontWeight: 'bold', marginTop: '6px' }}>{stats.confirmed}</div>
      </div>
      <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(212, 175, 55, 0.1)', borderRadius: '16px', padding: '18px' }}>
