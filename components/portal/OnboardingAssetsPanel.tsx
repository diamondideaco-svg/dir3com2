          ...
          return (
            <article key={asset.id} className="rounded-xl border border-[color:var(--color-border)] bg-[var(--color-surface)] p-4">
              <div className="mb-3 flex flex-wrap items-center gap-2 text-xs">
                ...
                <span className="rounded-full bg-[#243447] px-2 py-1 text-[#DCE6F2]">{presentWorkflowValue(asset.dataStatus, language)}</span>
                <span className="rounded-full bg-[#243447] px-2 py-1 text-[#DCE6F2]">{presentWorkflowValue(asset.verificationStatus, language)}</span>
              </div>
