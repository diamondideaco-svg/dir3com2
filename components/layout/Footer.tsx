...
const copy = {
  ar: {
    footerCollections: [
      ...
      { title: 'الخدمات', links: [{ label: 'dir3 Drive', href: '/services/drive' }, { label: 'dir3 Stay', href: '/services/stay' }, { label: 'dir3 Fly', href: '/services/fly' }, { label: 'dir3 Concierge', href: '/services/concierge' }, { label: 'dir3 VIP', href: '/services/vip' }] },
    ],
  ...
  en: {
    footerCollections: [
      ...
      { title: 'Services', links: [{ label: 'dir3 Drive', href: '/services/drive' }, { label: 'dir3 Stay', href: '/services/stay' }, { label: 'dir3 Fly', href: '/services/fly' }, { label: 'dir3 Concierge', href: '/services/concierge' }, { label: 'dir3 VIP', href: '/services/vip' }] },
    ],
...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-[color:var(--color-gold)]/25 bg-[linear-gradient(180deg,#ffffff_0%,#faf8f4_100%)] text-[var(--color-navy)]" dir={direction}>
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.7fr_0.7fr_0.9fr]">
          <div className="max-w-lg">
            <div className="flex items-center gap-3">
              <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[linear-gradient(180deg,rgba(212,175,55,0.24)_0%,rgba(255,255,255,0.08)_100%)] text-[var(--color-gold)] shadow-[0_18px_36px_rgba(15,23,42,0.06)]">
                <FiShield size={22} />
              </span>
              <div>
            ...
            <div className="mt-6 rounded-[28px] border border-[color:var(--color-border)] bg-[var(--color-surface)] p-4 text-sm leading-8 text-[var(--color-muted)] shadow-[0_18px_40px_rgba(15,23,42,0.06)]">
              {t.assistant}
            </div>
            <div className="mt-4 rounded-[20px] border border-[var(--color-gold)]/30 bg-[var(--color-gold)]/10 p-4 text-sm leading-7 text-[var(--color-muted)]">
              <p className="font-semibold text-[var(--color-gold)]">{t.operator}</p>
              <p className="mt-1 text-[var(--color-muted)]">{t.verificationNote}</p>
            </div>
            <div className="mt-6 flex flex-wrap gap-3 text-sm">
              <a href="https://dir3com.com" target="_blank" rel="noreferrer noopener" className="inline-flex items-center gap-2 rounded-full border border-[color:var(--color-border)] px-4 py-2 transition hover:border-[var(--color-gold)] hover:text-[var(--color-gold)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-gold)]/45">
                dir3com.com <FiArrowUpLeft />
              </a>
              <a href="https://dir3com.net" target="_blank" rel="noreferrer noopener" className="inline-flex items-center gap-2 rounded-full border border-[color:var(--color-border)] px-4 py-2 transition hover:border-[var(--color-gold)] hover:text-[var(--color-gold)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-gold)]/45">
          ...
          <div>
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2 sm:gap-2 lg:grid-cols-1 lg:gap-3">
              <button type="button" className="inline-flex items-center justify-center gap-2 rounded-full border border-[color:var(--color-border)] bg-[var(--color-surface)] px-4 py-3 text-sm font-medium transition hover:border-[var(--color-gold)] hover:text-[var(--color-gold)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-gold)]/45">
              ...
              {socialLinks.map(({ href, label }) => {
                ...
                return (
                  <Link
                    ...
                    aria-label={label}
                    className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-[color:var(--color-border)] bg-[var(--color-surface)] transition hover:-translate-y-0.5 hover:border-[var(--color-gold)] hover:text-[var(--color-gold)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-gold)]/45"
                  >
                    <Icon size={15} />
                  </Link>
                );
            ...
            <div className="mt-4 flex flex-wrap gap-2 text-xs text-[var(--color-muted)]">
              {whatsapp.eg ? (
                <a href={whatsapp.eg} target="_blank" rel="noreferrer noopener" className="rounded-full border border-[color:var(--color-border)] bg-[var(--color-surface)] px-3 py-1.5 transition hover:border-[var(--color-gold)] hover:text-[var(--color-gold)]">
                  {t.whatsappEg}
                </a>
              ) : null}
              {whatsapp.sa ? (
                <a href={whatsapp.sa} target="_blank" rel="noreferrer noopener" className="rounded-full border border-[color:var(--color-border)] bg-[var(--color-surface)] px-3 py-1.5 transition hover:border-[var(--color-gold)] hover:text-[var(--color-gold)]">
                  {t.whatsappSa}
                </a>
              ) : null}
            </div>
        ...
        <div className="mt-10 border-t border-[color:var(--color-border)] pt-6 text-sm text-[var(--color-muted)] sm:flex sm:items-center sm:justify-between">
          <p>{t.rights}</p>
