  ...
  return (
    ...
    >
      <button
        ...
        title="اسأل الدبرة"
        aria-label="الدبرة"
        className="group flex min-h-14 items-center gap-3 rounded-full border border-[var(--color-gold)]/40 bg-[linear-gradient(150deg,#0d1b2a_0%,#163149_100%)] px-3 py-3 text-right text-[var(--color-light)] shadow-[0_26px_56px_rgba(13,27,42,0.3)] transition"
      >
