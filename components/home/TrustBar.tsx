    ...
    <section className="px-4 pb-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl rounded-[36px] border border-[color:var(--color-border)] bg-[linear-gradient(155deg,rgba(13,27,42,0.98)_0%,rgba(18,37,56,0.95)_75%,rgba(212,175,55,0.2)_160%)] p-4 text-[var(--color-light)] shadow-[0_28px_70px_rgba(13,27,42,0.24)] sm:p-6">
        ...
        <div className="mb-5 flex flex-wrap items-center justify-center gap-2 text-xs sm:text-sm">
          <span className="rounded-full border border-white/20 bg-white/10 px-3 py-2">DIR3 Shield</span>
          <span className="rounded-full border border-white/20 bg-white/10 px-3 py-2">Transparent Pricing</span>
          <span className="rounded-full border border-white/20 bg-white/10 px-3 py-2">Always With You</span>
        </div>
