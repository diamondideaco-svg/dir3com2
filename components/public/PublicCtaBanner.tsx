      ...
      <ContentContainer>
        <CtaBlock className="rounded-[36px] px-6 py-8 shadow-[0_28px_65px_rgba(13,27,42,0.2)] sm:px-8 lg:px-10">
          <div className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              <span className="inline-flex items-center gap-2 rounded-full border border-[color:var(--color-border)] bg-[var(--color-surface)] px-4 py-2 text-sm text-[var(--color-gold)]">
                <HiSparkles /> dir3com brand surface
              </span>
