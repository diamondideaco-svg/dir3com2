      ...
      <ContentContainer>
        <SectionSurface className="rounded-[32px] p-4 shadow-[0_18px_40px_rgba(13,27,42,0.06)]">
          <ResponsiveGrid className="gap-4 xl:grid-cols-3">
            {stats.map((stat) => (
              <div key={stat.label} className="rounded-[24px] bg-[linear-gradient(180deg,rgba(255,250,242,0.96)_0%,rgba(239,228,210,0.82)_100%)] px-5 py-5 text-center shadow-[0_10px_24px_rgba(16,32,51,0.05)]">
